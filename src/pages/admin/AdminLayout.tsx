    ...
    <main className="bg-[#f5f7fb] min-h-screen">
      <div className="container-x py-6 md:py-8">
        <div className="grid lg:grid-cols-[240px_1fr] gap-6">
          {/* Sidebar */}
          <aside className="bg-white border border-rule rounded-lg p-4 self-start lg:sticky lg:top-24">
            ...
            <div className="border-t border-rule mt-5 pt-4">
              <a href="#/" onClick={(e) => { e.preventDefault(); navigate('/'); }}
                className="flex items-center gap-2 text-xs text-mute hover:text-brand-500 mb-2">
